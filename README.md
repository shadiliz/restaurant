...
### What do I do from here?
 ...
 3. In order to load the map you should replace the <your MAPBOX API KEY HERE> with token from [Mapbox](https://www.mapbox.com/) and add it in index.htm and restaurant.html.
